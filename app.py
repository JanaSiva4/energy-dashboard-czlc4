...
st.markdown("""
    ...
    /* Změna barev multiselect kolonek (Místo červené/modré) */
    span[data-baseweb="tag"] {
        background-color: rgba(255, 255, 255, 0.1) !important; /* Temně šedá s průhledností */
