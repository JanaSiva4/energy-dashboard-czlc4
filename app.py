...
<style>
    ...
    /* --- BARVY MULTISELECTU (ŠEDÁ MÍSTO ČERVENÉ) --- */
    ...
    div.stButton > button:hover {
        opacity: 0.3 !important; /* Efekt bleskového zmizení */
...
with col_main:
    ...
    if st.session_state.vysledky:
        ...
        # Zde by následovala logika vykreslení karet jako v tvém původním kódu
