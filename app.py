...
def generovat_pdf_protokol(zamestnanec, sklad, kvartal, vydane_polozky, vedouci, velikosti=None):
    ...
    # Úvodní text
    el.append(Paragraph("Předávající přejímá a předávající předává:", body_s))
    el.append(Spacer(1, 0.3*cm))
    ...
    polozky_def = [
        ('1× Ručník Siguro 50×100 cm', 'rucnik',  '50×100 cm, froté',        True),
    ...
    # Věta z originálu
    el.append(Paragraph(
        "Předávající stvrzuje, že se řádně seznámil se stavem předmětu "
